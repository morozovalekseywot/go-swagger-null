...
// SetValue changes this Float32's value and also sets it to be non-null.
func (f *Float32) SetValue(value float32) {
	f.Float32 = value
	f.Valid = true
	f.Set = true
}
