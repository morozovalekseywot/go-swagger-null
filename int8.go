...
func NewInt8(value int8, valid bool) Int8 {
	return Int8{
		Int8:  value,
		Valid: valid,
		Set:   true,
...
// SetValue changes this Int8's value and also sets it to be non-null.
func (i *Int8) SetValue(value int8) {
	i.Int8 = value
	i.Valid = true
	i.Set = true
}
